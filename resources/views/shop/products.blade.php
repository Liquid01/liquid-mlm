                ...
                <div class="row">
                    ...
                    <div class="col s10 m6 l6">
                        ...
                        <ol class="breadcrumbs mb-0">
                            ...
                            <li class="breadcrumb-item active">Member Shop
                ...
                <aside id="right-sidebar-nav">
                    ...
                    <div id="slide-out-right"
                        ...
                        <span class="avatar-status avatar-online avatar-50"><img
                                    ...
                                    src="{{asset('backassets/images/avatar/avatar-7.png')}}" alt="avatar">
                        ...
                        <span class="avatar-status avatar-online avatar-50"><img
                                    ...
                                    src="{{asset('backassets/images/avatar/avatar-1.png')}}" alt="avatar">
                        ...
                        <span class="avatar-status avatar-off avatar-50"><img
                                    ...
                                    src="{{asset('backassets/images/avatar/avatar-2.png')}}" alt="avatar">
                        ...
                        <span class="avatar-status avatar-online avatar-50"><img
                                    ...
                                    src="{{asset('backassets/images/avatar/avatar-3.png')}}" alt="avatar">
                        ...
                        <span class="avatar-status avatar-online avatar-50"><img
                                    ...
                                    src="{{asset('backassets/images/avatar/avatar-4.png')}}" alt="avatar">
                        ...
                        <span class="avatar-status avatar-off avatar-50"><img
                                    ...
                                    src="{{asset('backassets/images/avatar/avatar-5.png')}}" alt="avatar">
                        ...
                        <span class="avatar-status avatar-online avatar-50"><img
                                    ...
                                    src="{{asset('backassets/images/avatar/avatar-6.png')}}" alt="avatar">
                        ...
                        <span class="avatar-status avatar-off avatar-50"><img
                                    ...
                                    src="{{asset('backassets/images/avatar/avatar-8.png')}}" alt="avatar">
                        ...
                        <span class="avatar-status avatar-online avatar-50"><img
                                    ...
                                    src="{{asset('backassets/images/avatar/avatar-9.png')}}" alt="avatar">
                        ...
                        <span class="avatar-status avatar-off avatar-50"><img
                                    ...
                                    src="{{asset('backassets/images/avatar/avatar-10.png')}}" alt="avatar">
                        ...
                        <span class="avatar-status avatar-off avatar-50"><img
                                    ...
                                    src="{{asset('backassets/images/avatar/avatar-11.png')}}" alt="avatar">
                        ...
                        <span class="avatar-status avatar-online avatar-50"><img
                                    ...
                                    src="{{asset('backassets/images/avatar/avatar-12.png')}}" alt="avatar">
                           ...
                           <i></i>
                                ...
                                <div class="ps__rail-y" style="top: 0px; height: 668px; right: 0px;">

                                    <div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 342px;"></div>
