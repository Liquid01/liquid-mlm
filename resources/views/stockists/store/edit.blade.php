        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col s10 m6 l6">
                    ...
                    <h5 class="breadcrumbs-title mt-0 mb-0">Edit Store</h5>
        ...
        <div class="col s12 m8 l8 offset-l2 ">
            ...
            <div id="" class=" ">
                ...
                <div class="card-content">
                    ...
                    <form class="col s12" method="post" action="{{route('stockist_update_store', $store->id)}}" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="input-field col s12">
                                ...
                                <input id="name" name="name" required type="text" value="{{old('name', $store->name)}}" class="{{ $errors->has('name') ? ' is-invalid' : '' }}">
                        ...
                        <div class="row">
                            <div class="input-field col s12">
                                ...
                                <input id="address1" name="address1" required type="text" value="{{old('address1', $store->address1)}}" class="{{ $errors->has('address1') ? ' is-invalid' : '' }}">
                        ...
                        <div class="row">
                            <div class="input-field col s12">
                                ...
                                <input id="address2" name="address2"  type="text" value="{{old('address2', $store->address2)}}" class="{{ $errors->has('address2') ? ' is-invalid' : '' }}">
                        ...
                        <div class="row">
                            <div class="input-field col s12">
                                ...
                                <input id="city" name="city"  type="text" value="{{old('city', $store->city)}}" class="{{ $errors->has('city') ? ' is-invalid' : '' }}">
                            ...
                            <div class="input col s12">
                                <select name="state" required
                                    ...
                                    @foreach($states as $key => $state)
                                        <option value="{{$state}}" {{$store->state == $state? 'selected':''}}>{{$state}}</option>
                                    @endforeach
                                </select>
                                @if ($errors->has('state'))
