<div class="banner small-agency-home-header-bg" id="top">
    ...
    <div class="container">
        <div class="banner-content">
            <h1>Achieve Excellence.</h1>
                <h1>Learn  &amp; Earn</h1>
            <p class="section-subheading">
                You too can earn in <strong>7 Figures.</strong> We make it happen here.
            </p>
            <a href="{{route('register')}}" class="custom-btn btn-big grad-style-ef page-scroll">Start Now!</a>
        </div>
