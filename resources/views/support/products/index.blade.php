            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col s10 m6 l6">
                        ...
                        <h5 class="breadcrumbs-title mt-0 mb-0">PRODUCTS</h5>
                ...
                <div class="section section-data-tables">
                    ...
                    <div class="card center-align">
                        ...
                        <div class="card-content" style="padding: 20px 5px;">
                            ...
                            <a href="{{route('create_product')}}" data-target="modal1" class=" modal-trigger waves-effect waves-light btn btn-small gradient-45deg-light-blue-cyan z-depth-4 mb-2">
                                                        ...
                                                        @forelse($products as $product)
                                                            ...
                                                            <tr role="row" class="even">
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <img src="{{asset('assets/img/products/productThumbImage/'.$product->image)}}" style="max-width: 150px;" alt="">
