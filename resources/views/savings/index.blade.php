            ...
            <div class="container">
                <div class="row">
                    <div class="col s10 m6 l6">
                        <h5 class="breadcrumbs-title mt-0 mb-0">SAVINGS (THRIFT)</h5>
                        <ol class="breadcrumbs mb-0">
                            <li class="breadcrumb-item"><a href="{{route('dashboard')}}">Dashboard</a>
                            </li>
                            <li class="breadcrumb-item active">All Savings
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="section section-data-tables">
                    <div class="card center-align">
                        <div class="card-content" style="padding: 20px 5px;">
                            <a  href="{{route('new_savings_account')}}"
                                    class=" waves-effect waves-light btn btn-small gradient-45deg-light-blue-cyan z-depth-4 mb-2">
                                New Savings Plan
                            </a>
                            ...
                            <button data-target="modal-deposit"
                                    class="modal-trigger waves-effect waves-light btn btn-small gradient-45deg-red-pink z-depth-4 mb-2">
                                Deposit
                            </button>
                        </div>
                                                        ...
                                                        @forelse($savings as $saving)
                                                            ...
                                                            <tr role="row" class="even">
                                                                ...
                                                                <td>
                                                                    ...
                                                                    @case(1)
                                                                    <span>Matured, Not Collected</span>
                                                                    @break

                                                                    @case(2)
                                                                    <span>Matured, Collected at: {{$saving->withdrawal_date}}</span>
                                                                    @break

                                                                    @case(3)
                                                                    <span>Matured, rollover date: {{$saving->reinvested_date}}</span>
                                                                    @break
