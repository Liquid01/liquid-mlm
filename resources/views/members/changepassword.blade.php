                    ...
                    <div class="container">
                        <div class="login-wrapper">
                            <div class="card-wrapper">
                                <a href="{{url('/')}}" class="black-text bold ml-1 mr-1">Home</a>
                                <a href="{{route('my_profile', $username)}}" class="black-text bold ml-1 mr-1">Back</a>
                                <a href="{{route('dashboard')}}" class="black-text bold ml-1 mr-1">Dashboard</a>
                            </div>
                            <div class="card-wrapper">
                                <h1 class="title orange-text">Change Password</h1>
                                @include('includes.flash')
                                <form method="POST" action="{{route('update_member_password')}}">
                                    @csrf
                                    @isset($username)
