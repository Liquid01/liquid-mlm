        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col s10 m6 l6">
                    ...
                    <h5 class="breadcrumbs-title mt-0 mb-0">MY MATRYX</h5>
                    ...
                    <ol class="breadcrumbs mb-0">
                        ...
                        <li class="breadcrumb-item active">My Matrix
        ...
        <div class="col s12 m12 l12">
            ...
            <div id="swipeable-tabs" class="card card card-default scrollspy">
                ...
                <div class="card card-hero">
                    ...
                    <h4 class="header center">Stage {{app('current_user')->stage}} Matrix</h4>
        ...
        <div class="container mt-50 hide-on-small-only">
            ...
            <div class="card card-hero pb-3">
                ...
                <div class="mb-3">
                    ...
                    <h5>Stage  {{app('current_user')->stage}} Matrix</h5>
